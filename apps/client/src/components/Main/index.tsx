...
export const Main: FC = () => {
	...
	return (
		<div className="flex flex-1 overflow-hidden">
			{/* 左侧文件树 */}
			<div className="min-w-64 border-r border-zinc-200 bg-card flex flex-col">
			...
			<div className="flex-1 flex flex-col">
				{/* 文件标签栏 */}
				<div className="flex items-center px-4 py-1 border-b border-zinc-200 bg-muted/30">
					<div className="flex items-center gap-2 px-3 py-1.5 bg-background rounded-t-md border border-zinc-200 border-b-0">
