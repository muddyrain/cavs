import { BlockSchema, InlineContentSchema, StyleSchema, SuggestionMenuState } from "@blocknote/core"
...
type ItemType<GetItemsType extends (query: string) => Promise<any[]>> = ArrayElement<
...
>(
	...
	const getItemsOrDefault = useMemo(() => {
		return (
			getItems ||
			((async (query: string) =>
				await getDefaultReactEmojiPickerItems(editor, query)) as any as typeof getItems)
		)
	}, [editor, getItems])!
