import { FileBlockConfig, audioBlockConfig, audioParse } from "@cavs/editor-core"

import { RiVolumeUpFill } from "react-icons/ri"

import { ReactCustomBlockRenderProps, createReactBlockSpec } from "../../schema/ReactBlockSpec.js"
...
export const AudioPreview = (
	...
	return (
		<audio
			className={"bn-audio"}
			src={resolved.loadingState === "loading" ? props.block.props.url : resolved.downloadUrl}
			controls={true}
...
export const AudioToExternalHTML = (
	props: Omit<ReactCustomBlockRenderProps<typeof audioBlockConfig, any, any>, "contentRef">
) => {
