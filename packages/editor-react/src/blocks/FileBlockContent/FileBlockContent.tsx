import { fileBlockConfig, fileParse } from "@cavs/editor-core"

import { createReactBlockSpec, ReactCustomBlockRenderProps } from "../../schema/ReactBlockSpec.js"
...
export const FileToExternalHTML = (
	props: Omit<ReactCustomBlockRenderProps<typeof fileBlockConfig, any, any>, "contentRef">
) => {
