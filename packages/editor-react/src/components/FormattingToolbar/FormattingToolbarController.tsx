import { BlockSchema, DefaultProps, InlineContentSchema, StyleSchema } from "@cavs/editor-core"
...
export const FormattingToolbarController = (props: {
	...
	useEditorContentOrSelectionChange(() => {
		...
		if (!("textAlignment" in block.props)) {
			...
			setPlacement(
				textAlignmentToPlacement(block.props.textAlignment as DefaultProps["textAlignment"])
			)
		}
	}, editor)
