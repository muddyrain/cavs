import { DefaultBlockSchema, InlineContentSchema, StyleSchema } from "@cavs/editor-core"
...
export const TableCellMergeButton = () => {
	...
	if (!editor.isEditable || mergeDirection === undefined || !editor.settings.tables.splitCells) {
		return null
	}
	...
	return (
		<Components.FormattingToolbar.Button
			...
			icon={mergeDirection === "horizontal" ? <RiMergeCellsHorizontal /> : <RiMergeCellsVertical />}
			onClick={onClick}
		/>
	)
}
