import { Block, BlockSchema, Dictionary, InlineContentSchema, StyleSchema } from "@cavs/editor-core"
...
import { ComponentProps, useComponentsContext } from "../../../editor/ComponentsContext.js"
...
export const blockTypeSelectItems = (dict: Dictionary): BlockTypeSelectItem[] => [
	...
	},
	{
		...
		icon: RiH4,
		isSelected: (block) =>
			block.type === "heading" && "level" in block.props && block.props.level === 4
	},
	{
		...
		icon: RiH5,
		isSelected: (block) =>
			block.type === "heading" && "level" in block.props && block.props.level === 5
	},
	{
		...
		icon: RiH6,
		isSelected: (block) =>
			block.type === "heading" && "level" in block.props && block.props.level === 6
	},
	{
