import { BlockFromConfig, BlockNoteEditor, BlockSchemaWithBlock, CustomBlockConfig, InlineContentSchema, PartialBlockFromConfig, PropSchema, Props, StyleSchema } from "@cavs/editor-core";
...
export declare function createReactBlockSpec<const T extends CustomBlockConfig, const I extends InlineContentSchema, const S extends StyleSchema>(blockConfig: T, blockImplementation: ReactCustomBlockImplementation<T, I, S>): {
    config: T;
    implementation: import("@cavs/editor-core").TiptapBlockImplementation<T, any, InlineContentSchema, StyleSchema>;
};
